require('dotenv').config(); // 1. Load environment variables at the very top
...
app.post('/login', async (req, res) =>{
  try{
    ...
    // FIX: Changed .rowCount.length to just .rows.length
...
// GET ALL TASKS (Correct version with authorization)
